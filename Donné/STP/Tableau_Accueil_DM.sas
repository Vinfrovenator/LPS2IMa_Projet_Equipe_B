...
*
*  ====================================================================
*  Nom de l'application stockée : Tableau_Accueil_DM
*  ====================================================================
*
...
CREATE TABLE work.transi as
	...
	AND id_magasin in(select id_magasin from ora12015.requete_geo where code = &I_REGION_DM.)
;
quit;
...
PROC SQL;
   ...
   SELECT t3.LIB_FAMILLE_PRODUIT,
          /* SUM_of_OBJECTIF */
            (SUM(OBJECTIF)) LABEL="CA budgeté" AS CA_Objectif, 
          /* SUM_of_REEL */
            (SUM(REEL))  LABEL="CA réel" AS CA_Reel
...
PROC SQL;
   ...
   SELECT t3.LIB_FAMILLE_PRODUIT,
          /* SUM_of_OBJECTIF */
            (SUM(OBJECTIF))  LABEL="Ventes budgetées" AS Ventes_Objectif, 
          /* SUM_of_REEL */
            (SUM(REEL))  LABEL="Ventes réelles" AS Ventes_Reel
         FROM ora12015.DIM_MAGASIN_STAR t1, work.transi t2, ora12015.DIM_FAMILLE_PRODUIT t3
...
PROC SQL;
   ...
   SELECT t3.LIB_FAMILLE_PRODUIT,
          /* SUM_of_OBJECTIF */
            (SUM(OBJECTIF))  LABEL="Marge budgetée" AS Marge_Objectif, 
          /* SUM_of_REEL */
            (SUM(REEL)) LABEL="Marge réelle" AS Marge_Reel
         FROM ora12015.DIM_MAGASIN_STAR t1, work.transi t2, ora12015.DIM_FAMILLE_PRODUIT t3
...
/* Zone géographique */
  ...
  from ora12015.select_zone_geo_DM
