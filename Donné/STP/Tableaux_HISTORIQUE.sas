...
*
*  ====================================================================
*  Nom de l'application stockée : Tableau_Historique_DC
*
*  Description : Permet la production du tableau historique pour le
...
/* ----------------------------------------------------------------------*/
			/* Tableau d'historique pour le directeur commercial du groupe DARTIES */
...
PROC SQL;
   ...
   SELECT t2.LIB_FAMILLE_PRODUIT LABEL="Famille de produit", 
          /* SUM_of_OBJECTIF */
            sum(OBJECTIF) FORMAT=12.2 LABEL="Données budgetées" AS SUM_of_VENTES_OBJECTIF, 
          /* SUM_of_REEL */
            sum(REEL) FORMAT=12.2 LABEL="Données réelles" AS SUM_of_VENTES_REEL, 
          /* Ecart */
...
PROC SQL;
   ...
   SELECT t2.LIB_FAMILLE_PRODUIT LABEL="Famille de produit", 
          /* SUM_of_OBJECTIF */
           (SUM(OBJECTIF)) FORMAT=12.2 LABEL="Données budgetées cumulées" AS SUM_of_VENTES_OBJECTIF_cumul, 
          /* SUM_of_REEL */
          (SUM(REEL)) FORMAT=12.2 LABEL="Données réelles cumulées" AS SUM_of_VENTES_REEL_cumul, 
          /* Ecart */
            (((SUM(REEL)) - (SUM(OBJECTIF))) / (SUM(OBJECTIF))) FORMAT=PERCENTN8.2 LABEL=
...
PROC SQL;
   ...
   SELECT t2.LIB_FAMILLE_PRODUIT LABEL="Famille de produit", 
          /* SUM_of_OBJECTIF */
            sum(OBJECTIF) FORMAT=12.2 LABEL="Données budgetées N-1" AS SUM_of_VENTES_OBJECTIF_prec, 
          /* SUM_of_REEL */
            sum(REEL) FORMAT=12.2 LABEL="Données réelles N-1" AS SUM_of_VENTES_REEL_prec, 
          /* Ecart */
            (sum(REEL) - sum(OBJECTIF)) / sum(OBJECTIF) FORMAT=PERCENTN8.2 LABEL=
...
PROC SQL;
   ...
   SELECT t2.LIB_FAMILLE_PRODUIT LABEL="Famille de produit", 
          /* SUM_of_OBJECTIF */
            (SUM(OBJECTIF)) FORMAT=12.2 LABEL="Données budgetées N-1 cumulées" AS SUM_of_VENTES_OBJECTIF_cum2, 
          /* SUM_of_REEL */
            (SUM(REEL)) FORMAT=12.2 LABEL="Données réelles N-1 cumulées" AS SUM_of_VENTES_REEL_cum2, 
          /* Ecart */
            (sum(REEL) - sum(OBJECTIF)) / sum(OBJECTIF) FORMAT=PERCENTN8.2 LABEL=
...
select "Total" as Total, 
						 ...
						 sum(SUM_of_VENTES_REEL_prec) format=12.2 as SUM_of_VENTES_REEL_prec,
						 sum(SUM_of_VENTES_OBJECTIF_prec) format=12.2 as SUM_of_VENTES_OBJECTIF_prec,
						 ((sum(SUM_of_VENTES_REEL_prec)-sum(SUM_of_VENTES_OBJECTIF_prec))/sum(SUM_of_VENTES_OBJECTIF_prec)) format=percentn8.2 as Ecart_ventes_prec,

						 /* Données année N-1 cumulées */
						 sum(SUM_of_VENTES_REEL_cum2) format=12.2 as SUM_of_VENTES_REEL_cum2,
						 sum(SUM_of_VENTES_OBJECTIF_cum2) format=12.2 as SUM_of_VENTES_OBJECTIF_cum2,
						 ((sum(SUM_of_VENTES_REEL_cum2)-sum(SUM_of_VENTES_OBJECTIF_cum2))/sum(SUM_of_VENTES_OBJECTIF_cum2)) format=percentn8.2 as Ecart_ventes_cum2,

						 /* Données actuelles non cumulées */
						 sum(SUM_of_VENTES_REEL) format=12.2 as SUM_of_VENTES_REEL,
						 sum(SUM_of_VENTES_OBJECTIF) format=12.2 as SUM_of_VENTES_OBJECTIF,
						 ((sum(SUM_of_VENTES_REEL)-sum(SUM_of_VENTES_OBJECTIF))/sum(SUM_of_VENTES_OBJECTIF)) format=percentn8.2 as Ecart_ventes,

						 /* Données actuelles cumulées */
						 sum(SUM_of_VENTES_REEL_cumul) format=12.2 as SUM_of_VENTES_REEL_cumul,
						 sum(SUM_of_VENTES_OBJECTIF_cumul) format=12.2 as SUM_of_VENTES_OBJECTIF_cumul,
						 ((sum(SUM_of_VENTES_REEL_cumul)-sum(SUM_of_VENTES_OBJECTIF_cumul))/sum(SUM_of_VENTES_OBJECTIF_cumul)) format=percentn8.2 as Ecart_ventes_cumul
