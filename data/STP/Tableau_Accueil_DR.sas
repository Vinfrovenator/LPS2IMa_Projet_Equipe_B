...
*
*  ====================================================================
*  Nom de l'application stockée : Tableau_Accueil_DR
*  ====================================================================
*
...
*  I_REGION_DR
*       Type : Numérique
*      Libellé : Choix de la zone (direction régionale)
*       Attr: Visible
*  ____________________________________
*  I_TEMPS
*       Type : Texte
...
/* ----------------------------------------------------------------------*/
			/* -- Tableau d'accueil pour le directeur régionnal du groupe DARTIES --*/
...
CREATE TABLE work.transi as
	...
	AND id_magasin in(select id_magasin from ora12015.requete_geo where code = &I_REGION_DR.)
;
quit;
...
TITLE;
TITLE1 "Détail région &REGION. en &ANNEE_CURR. en &DEVISE., tout les produits, Tout les indicateurs";
